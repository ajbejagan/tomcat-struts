...
<body>
    ...
    <main class="bg-neutral-50 py-5" style="height: calc(100vh - 128px);">
        <div class="max-w-screen-lg mx-auto">
            <img class="mt-10 mx-auto mb-5" src="https://media1.giphy.com/media/agmheddabICHK/200.gif" alt="okay" style="width:267px; height:200px;">
            <h1 class="text-3xl text-gray-900 mb-4">This is the About page</h1>
